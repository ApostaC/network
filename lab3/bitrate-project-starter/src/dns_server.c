...
typedef int (*ip_getter_t )(const char *,const char *,struct in_addr **);
...
int naive_getip(const char * targetaddr,const char * srcaddr,
				struct in_addr ** pinaddrref);
int rr_getip(const char * targetaddr, const char * srcaddr,
			struct in_addr ** pinaddrref);
int ls_getip(const char * addr, const char * srcaddr,
			struct in_addr ** pinaddrref);
...
int naive_getip(const char * addr, const char * srcaddr, struct in_addr ** pinaddrref)
{
...
int rr_getip(const char * addr, const char * srcaddr, struct in_addr ** pinaddrref)
{
	if(!curr_round_robin)
		return -1;
	if(!is_addr_correct(addr)) return -1;
...
int ls_getip(const char * addr, const char * srcaddr,struct in_addr ** pinaddrref)
{
