 ...
 */		
size_t fill_request(int req_num, const char * req_addrs[],int id, char * payload);
 ...
 *			else return 0 [ERROR OCCURED]
 */
size_t fill_response(int req_num, const char * req_addrs[],int id,  
					const struct in_addr * res_addrs[], char * payload, int flag);
 ...
 */
int set_client_ip(const char * client_ip);
